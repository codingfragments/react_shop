      ...
      <div className="space-y-3 p-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className={`bg-primary hover:bg-secondary disabled:bg-overlay0 disabled:text-text-muted relative overflow-hidden rounded-lg border-2 border-transparent px-4 py-2 text-base text-sm font-medium transition-all duration-200 active:scale-95 hover:enabled:border-violet-800 hover:enabled:font-bold disabled:cursor-not-allowed ${isAddingToCart ? 'animate-pulse bg-success border-success' : ''
              }`}
          >
            {isAddingToCart ? (
              <>

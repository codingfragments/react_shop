      ...
      <div className="container mx-auto px-4 py-4" style={{ maxWidth: 1200 }}>
        <nav className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <Link to="/" className="flex items-center space-x-3 transition-colors hover:text-primary">
              ...
              <div className="hidden sm:block">
                ...
                <p className="text-xs leading-none text-text-muted">GREAT Keyboards</p>
              </div>
            </Link>
          </div>
          ...
          <div className="hidden items-center space-x-8 lg:flex">
            <Link
              to="/"
              className={`font-medium text-text-primary transition-colors hover:text-primary ${location.pathname === '/' ? 'text-base' : ''
                }`}
            >
              Home
            </Link>
            ...
            <Link
              to="/products"
              className={`font-medium text-primary transition-colors hover:text-primary ${location.pathname === '/products' ? 'text-base' : ''
                }`}
            >
              All Products
            </Link>
            ...
            <Link
              to="/faq"
              className={`font-medium text-text-primary transition-colors hover:text-primary ${location.pathname === '/faq' ? 'text-base' : ''
                }`}
            >
              FAQ
            </Link>
            ...
            <div className="relative">
              <button
                ...
                className={`flex items-center space-x-1 font-medium text-text-primary transition-colors hover:text-primary ${location.pathname.startsWith('/categories') ? 'text-base' : ''
                  }`}
              >
          ...
          <div className="flex items-center space-x-4">
            ...
            <Link
              to="/cart"
              className={`relative p-2 text-text-primary transition-colors hover:text-primary ${location.pathname === '/cart' ? 'text-base' : ''
                }`}
            >
